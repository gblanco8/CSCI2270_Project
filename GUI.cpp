...
void AddControls(HWND hWnd){
  ...
  hProfile = CreateWindowW(L"EDIT", L"'ENTER PROFILE NAME'", WS_VISIBLE | WS_CHILD | WS_BORDER, 190, 65, 150, 50, hWnd, NULL, NULL, NULL);


  CreateWindowW(L"Button", L"Add Task", WS_VISIBLE | WS_CHILD | WS_BORDER, 25, 130, 150, 50, hWnd, (HMENU)ADD_TASK, NULL, NULL);
  hName = CreateWindowW(L"EDIT", L"'ENTER TASK NAME'", WS_VISIBLE | WS_CHILD | WS_BORDER, 190, 130, 150, 50, hWnd, NULL, NULL, NULL);
  hLength = CreateWindowW(L"EDIT", L"'ENTER TASK LENGTH'", WS_VISIBLE | WS_CHILD | WS_BORDER, 355, 130, 150, 50, hWnd, NULL, NULL, NULL);
  hTime = CreateWindowW(L"EDIT", L"'ENTER TASK TIME'", WS_VISIBLE | WS_CHILD | WS_BORDER, 520, 130, 150, 50, hWnd, NULL, NULL, NULL);
  hCat = CreateWindowW(L"EDIT", L"'ENTER TASK CATEGORY'", WS_VISIBLE | WS_CHILD | WS_BORDER, 685, 130, 150, 50, hWnd, NULL, NULL, NULL);
  ...
  hTask = CreateWindowW(L"EDIT", L"'ENTER TASK NAME'", WS_VISIBLE | WS_CHILD | WS_BORDER, 190, 260, 150, 50, hWnd, NULL, NULL, NULL);
